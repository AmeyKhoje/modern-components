...
var GridElement = function (_a) {
    ...
    return (jsx("div", { className: "grid-element", style: customStyle, children: children }));
};

var GridElementsRenderer = function () {
    var _a = useContext(GridContext), divideBy = _a.divideBy, elements = _a.elements, gutterSpace = _a.gutterSpace;
    var ct = 0;
    return elements.map(function (item, index) {
        var _a;
        var element = createElement(GridElement, {
...
var GridInner = function () {
    return (jsx("div", { className: "flex items-start flex-wrap", children: jsx(GridElementsRenderer, {}) }));
};
...
var Grid = function (_a) {
    ...
    if (!(elements === null || elements === void 0 ? void 0 : elements.length) || !(divideBy === null || divideBy === void 0 ? void 0 : divideBy.length)) {
        return jsx(Fragment, { children: "Provide data" });
    }
    var isValidDivision = checkValidDivision(divideBy);
    if (!isValidDivision) {
        return jsx(Fragment, { children: "Given wrong input" });
    }
    var memoizedElements = useMemo(function () {
